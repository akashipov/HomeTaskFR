...
urlpatterns = [
    ...
    path("app/save_results", views.save_results, name="save_results"),
    path("app/register", views.register, name="register"),
    path("app/make_register", views.make_register, name="make_register"),
    path("app/login", views.login, name="login"),
    path("app/make_login", views.make_login, name="make_login"),
    path(
        "app/start_questionnaire/<int:id>/",
        views.start_questionnaire,
        name="start_questionnaire",
    ),
    path("<int:id>/", views.questions, name="questions"),
    path(
        "add_questionnaire/", views.add_questionnaire, name="add_questionnaire"
    ),
    ...
    path(
        "make_edit_questionnaire/",
        views.make_edit_questionnaire,
        name="make_edit_questionnaire",
    ),
    path(
        "make_edit_question/",
        views.make_edit_question,
        name="make_edit_question",
    ),
]
